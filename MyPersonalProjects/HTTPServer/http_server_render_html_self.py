...
class HandleClient(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == "C:\Users\mtumb\Documents\CodingEnv\Python\MyPersonalProjects\net322_25_cat2\templates":
            ...
            self.wfile.write(b"You Are In ~\templates!")
            
        elif self.path == "C:\Users\mtumb\Documents\CodingEnv\Python\MyPersonalProjects\net322_25_cat2\templates\index.html":
            self.send_response(200) # To Indicate That The resource has been fetched and transmitted in the message body.
            self.end_headers() # Adds a blank line (indicating the end of the HTTP headers in the response) to the headers buffer
            self.wfile.write(b"You Have Accessed The ~\index.html file!")
            
        elif self.path == "C:\Users\mtumb\Documents\CodingEnv\Python\MyPersonalProjects\net322_25_cat2\templates\register.html":
            ...
            self.wfile.write(b"You Have Accessed The ~\register.html file!")
